...
function createConfig(titleFontSize,iconWidth,iconHeight,iconFontSize,iconStartX,iconStartY,iconSpinX)
{
    ...
    rootloader.iconStartX = (rootloader.viewWidth - rootloader.iconWidth*4)/8;//iconStartX;
    rootloader.iconStartY = (rootloader.viewHeight - rootloader.iconHeight*3)/6;//iconStartY;
    rootloader.iconSpinX = (rootloader.viewWidth - rootloader.iconStartX/3)/4;//iconSpinX;
    rootloader.iconSpinY = (rootloader.viewHeight - rootloader.iconStartY)/3;
}
...
function setConfig()
{
   if(rootloader.viewWidth == 320 && rootloader.viewHeight == 240) {            //  320 * 240
        ...
        createConfig(10,40,40,10);//,50,20,80);
