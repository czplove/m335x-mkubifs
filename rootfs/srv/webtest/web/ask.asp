...
<body>
  ...
  <br>
	...
	<div id="mainContent">   
         ...
         <h3 align="center"><% getTestName(); %>测试结果</h3>
         <hr>
          <h4 align="left">测试现象是否正常体现？</h4>
          <form action=/goform/ackaskForm method=POST>
			     <table width=30% align="left">
                    <tr>
                        <td><input type=submit name="ack" value="Yes"></td> 
                        <td><input type=submit name="ack" value="NO"></td>
                    </tr>
                 </table>
          <br>
          <br>
